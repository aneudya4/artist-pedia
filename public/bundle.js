...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery-exposed.js");
...
var fetchArtistInfo = function (artistName) {
    var url = _config__WEBPACK_IMPORTED_MODULE_1__["default"].audiodbArtistBaseURL + artistName;
...
var fetchArtistAlbums = function (artistName) {
    $('.artist-details').hide();
    var url = _config__WEBPACK_IMPORTED_MODULE_1__["default"].audiodbAlbumsBaseURL + artistName;
    fetch(url)
        .then(function (response) {
        if (response.ok) {
            return response.json();
...
var fetchArtistEvent = function (artistName) {
    $('.artist-details').hide();
    var url = _config__WEBPACK_IMPORTED_MODULE_1__["default"].ticketMasterBaseURL + artistName;
    fetch(url)
        .then(function (response) {
        if (response.ok) {
            return response.json();
